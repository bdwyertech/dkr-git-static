...
RUN apk add git build-base autoconf curl-dev curl-static expat-dev gettext openssl-dev openssl-libs-static openssl1.1-compat-dev tcl tk zlib-dev zlib-static
